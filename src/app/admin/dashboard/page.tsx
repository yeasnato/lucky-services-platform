...
export default async function AdminDashboardPage() {
  ...
  const activeStatuses = ['assigned', 'accepted', 'on_the_way', 'in_progress', 'confirmed'];
  ...
  const statCards = [
    ...
    },
    {
      ...
      helper: `${fieldJobs.length} in field, ${confirmedBookings.length} awaiting assign`,
      icon: UserRoundCheck,
          ...
          <div className="overflow-x-auto">
            <table className="w-full min-w-[820px] text-left text-sm">
              ...
              <tbody className="divide-y divide-slate-100">
                {[...pendingBookings, ...unassignedConfirmed, ...fieldJobs].slice(0, 10).map((booking) => (
